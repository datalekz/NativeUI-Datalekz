...
namespace NativeUI
{
	...
	public class UIMenu
	{
		...
		public UIMenu(string title, string subtitle, bool glare = false) : this(title, subtitle, Font.HouseScript, new PointF(0, 0), "commonmenu", "interaction_bgd", glare)
		{
		}
		...
		/// <param name="glare">Add menu Glare scaleform?.</param>
		public UIMenu(string title, string subtitle, PointF offset, bool glare = false) : this(title, subtitle, Font.HouseScript, offset, "commonmenu", "interaction_bgd", glare)
		{
		}
		...
		/// <param name="glare">Add menu Glare scaleform?.</param>
		public UIMenu(string title, string subtitle, PointF offset, string customBanner) : this(title, subtitle, Font.HouseScript, offset, "commonmenu", "interaction_bgd", false)
		{
		...
		/// <param name="glare">Add menu Glare scaleform?.</param>
		public UIMenu(string title, string subtitle, Font titleFont, PointF offset, string spriteLibrary, string spriteName, bool glare = false)
		{
			Offset = offset;
			...
			_mainMenu.Items.Add(Title = new UIResText(title, new PointF(215 + Offset.X, 13 + Offset.Y), 1.15f, Colors.White, titleFont, Alignment.Center));
